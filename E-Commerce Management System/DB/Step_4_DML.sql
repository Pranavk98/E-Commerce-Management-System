--Package created to Insert Data into Tables with validations--
SET SERVEROUT ON;
...
BEGIN
    ...
    SELECT UNIT_PRICE, AVAILABLE_UNITS into price, units from PRODUCT where Product.PRODUCT_ID = PRODUCT_ID;
